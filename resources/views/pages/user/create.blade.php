    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('user.store') }}" id="addForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="masukan nama user" autocomplete="off">
                    <span class="text-danger error-text name_error"  style="font-size: 13px"></span>
                </div>          

                <div class="form-group">
                    <label>Email</label>
                    <input type="text" name="email" class="form-control" placeholder="masukan nama email" autocomplete="off">
                    <span class="text-danger error-text email_error"  style="font-size: 13px"></span>
                </div>          

                <div class="form-group">
                    <label>Kata Sandi</label>
                    <input type="text" name="password" class="form-control" placeholder="masukan password" autocomplete="off">
                    <span class="text-danger error-text password_error"  style="font-size: 13px"></span>
                </div>          

                <div class="form-group">
                    <label>Konfirmasi Kata Sandi</label>
                    <input type="text" name="password_confirmation" class="form-control" placeholder="masukan konfirmasi password" autocomplete="off">
        ...
        <div class="modal-footer">
            <button type="button" onclick="addUser();" class="btn btn-primary pull-left">Simpan</button>
